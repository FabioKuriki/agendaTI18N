<x-layout titulo="Consultar">
    ...
    <div class="container-fluid">
        <table class="table">
            <thead>
                <tr>
                    <th style="background-color: blue;" scope="col">Código</th>
                    <th style="background-color: blue" scope="col">Data</th>
                    <th style="background-color: blue" scope="col">Descrição</th>
                    <th style="background-color: blue" scope="col">Modificar</th>
                </tr>
            </thead>
            <tbody>
                <!-- while simplificado -->
