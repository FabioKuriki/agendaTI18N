<x-layout titulo="Editar">
    <form action="" method="GET">
        ...
        <label>Data:</label>
        <input type="date" id="dataEvento" name="dataEvento" value="" disabled required>
        <br><br>
        <label>Descrição:</label>
        <input type="text" id="descricao" name="descricao" value="" disabled required>
        <br><br>

        <button class="btn btn-primary" type="submit">Atualizar</button>
        <!-- Botão Excluir com Modal -->
        <button class="btn btn-primary" data-bs-toogle="modal" data-bs-target="#exampleModal">Excluir</button>
